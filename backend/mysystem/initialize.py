...
""")
    ...
    def init_button(self):
        ...
        self.button_data = [
            ...
            {"id": "4a2461feb66548348c3fab71b08bb3c5", "name": "统计", "value": "Statistics", },
            {"id": "e653a42beb3b450eb3f46a8747957de8", "name": "发货", "value": "Deliver", },
    ...
    def init_menu(self):
        ...
        self.menu_data = [
            ...
            {'id': '244b28685cd14a39a383189981510d4a', 'name': '用户管理', 'sort': 55, 'web_path': 'userManage','icon': 'el-icon-user', 'parent_id': None, 'component': None, 'component_name': None, 'visible': 1,'isautopm': 0},
            {'id': 'd4e2fe169a8b40f3846421ac04e4fccb', 'name': '平台设置', 'sort': 99, 'web_path': '','icon': 'el-icon-s-platform', 'parent_id': None, 'component': None, 'component_name': None, 'visible': 1,'isautopm': 0},
            {'id': 'ae5629946df4497cbec10419e8375dd9', 'name': '轮播图设置', 'sort': 1, 'web_path': 'carouselSettingsimg','icon': 'el-icon-menu', 'parent_id': 'd4e2fe169a8b40f3846421ac04e4fccb', 'component': None,'component_name': None, 'visible': 1, 'isautopm': 0},
            {'id': '3171db16eda048ae92b16536fc1241b6', 'name': '平台公告', 'sort': 5, 'web_path': 'messagNotice','icon': 'el-icon-menu', 'parent_id': 'd4e2fe169a8b40f3846421ac04e4fccb', 'component': None, 'component_name': None,'visible': 1, 'isautopm': 0},
            {'id': '144b872308704ddb9f549515361d4f08', 'name': '意见反馈', 'sort': 8, 'web_path': 'userFeekback','icon': 'el-icon-menu', 'parent_id': 'd4e2fe169a8b40f3846421ac04e4fccb', 'component': None, 'component_name': None,'visible': 1, 'isautopm': 0},
            {'id': '80a340eae92b430abe17635468c2df1d', 'name': '其他设置', 'sort': 12, 'web_path': 'platformSettingsother','icon': 'el-icon-menu', 'parent_id': 'd4e2fe169a8b40f3846421ac04e4fccb', 'component': None, 'component_name': None,'visible': 1, 'isautopm': 0},
            {'id': '462ac5104e574ee9814cca49d0855aa2', 'name': '商城管理', 'sort': 122, 'web_path': '','icon': 'el-icon-s-goods', 'parent_id': None, 'component': None, 'component_name': None, 'visible': 1,'isautopm': 0},
            {'id': '154ccc5162ba4ba59b0ed298b16e4bb9', 'name': '商品管理', 'sort': 1, 'web_path': 'goodsManage','icon': 'el-icon-menu', 'parent_id': '462ac5104e574ee9814cca49d0855aa2', 'component': None, 'component_name': None,'visible': 1, 'isautopm': 0},
            {'id': 'cc36f1840dd043a58c8dcc1583ef53a7', 'name': '商品分类', 'sort': 2, 'web_path': 'goodsType','icon': 'el-icon-menu', 'parent_id': '462ac5104e574ee9814cca49d0855aa2', 'component': None, 'component_name': None,'visible': 1, 'isautopm': 0},
            {'id': 'e11909bd9936486fbece90877af4244d', 'name': '财务管理', 'sort': 145, 'web_path': '','icon': 'el-icon-money', 'parent_id': None, 'component': None, 'component_name': None, 'visible': 1,'isautopm': 0},
            {'id': '4267b88be81141fb9c02bce4c0515e6d', 'name': '商品财务流水', 'sort': 1, 'web_path': 'financeStatisticsGoods', 'icon': 'el-icon-menu','parent_id': 'e11909bd9936486fbece90877af4244d', 'component': None, 'component_name': None, 'visible': 1,'isautopm': 0},
            {'id': '62a24e989dad4248837deed8582cd2cd', 'name': '订单管理', 'sort': 133, 'web_path': '','icon': 'el-icon-s-order', 'parent_id': None, 'component': None, 'component_name': None, 'visible': 1,'isautopm': 0},
            {'id': '9f41e3f4199f43218f332dce9b085829', 'name': '商城订单', 'sort': 1,'web_path': 'mallOrderManage', 'icon': 'el-icon-menu', 'parent_id': '62a24e989dad4248837deed8582cd2cd','component': None, 'component_name': None, 'visible': 1, 'isautopm': 0},
            {'id': '4236eb70-1558-43a0-9cf2-037230c547f9', 'name': '部门管理', 'sort': 1, 'web_path': 'departmentManage','icon': 'el-icon-menu', 'parent_id': '54f769b0-3dff-416c-8102-e55ec44827cc', 'component': 'system/dept', 'component_name': 'dept', 'visible': 1,'isautopm':0},
            {'id': '4ba07859-8b73-4524-a1a6-bbff36d98337', 'name': '操作日志', 'sort': 1, 'web_path': 'journalManage','icon': 'el-icon-menu', 'parent_id': 'c236fb6b-ddaa-4deb-b79b-16e42d9f347f', 'component': 'system/log/operationLog', 'component_name': 'operationLog', 'visible': 1,'isautopm':0},
            {'id': '56c3f341-4f46-4b04-9cfc-c8a14701707e', 'name': '菜单管理', 'sort': 2, 'web_path': 'menuManage','icon': 'el-icon-menu', 'parent_id': '54f769b0-3dff-416c-8102-e55ec44827cc', 'component': 'system/menu','component_name': 'menu', 'visible': 1,'isautopm':0},
            {'id': 'e0f53902-e901-490c-83f3-331e60b97fcf', 'name': '按钮配置', 'sort': 2,'web_path': 'buttonConfig/:id/:name', 'icon': 'el-icon-menu','parent_id': '54f769b0-3dff-416c-8102-e55ec44827cc', 'component': 'system/ menuButton', 'component_name': None, 'visible': 0,'isautopm':0},
            {'id': '15c9ebc5-d12f-470a-a560-938a7dc57570', 'name': '角色管理', 'sort': 3,'web_path': 'roleManage', 'icon': 'el-icon-menu','parent_id': '54f769b0-3dff-416c-8102-e55ec44827cc', 'component': 'system/role', 'component_name': 'role', 'visible': 1,'isautopm':0},
            {'id': 'a607e820-36e5-45c0-aabf-85a8e4e2c7ac', 'name': '权限管理', 'sort': 4,'web_path': 'authorityManage', 'icon': 'el-icon-menu','parent_id': '54f769b0-3dff-416c-8102-e55ec44827cc', 'component': 'system/rolePermission', 'component_name': 'rolePermission', 'visible': 1,'isautopm':0},
            {'id': '151035da-77a3-4a62-b474-fce6824571fb', 'name': '按钮管理', 'sort': 6,'web_path': 'buttonManage', 'icon': 'el-icon-menu','parent_id': '54f769b0-3dff-416c-8102-e55ec44827cc', 'component': 'system/button','component_name': 'buttonManage', 'visible': 0,'isautopm':0},
            {'id': '54f769b0-3dff-416c-8102-e55ec44827cc', 'name': '系统管理', 'sort': 200,'web_path': 'departmentManage', 'icon': 'el-icon-s-tools', 'parent_id': None,'component': None, 'component_name': None, 'visible': 1,'isautopm':0},
            {'id': 'fd29ed011f5e4fcda595977c132dbb7e', 'name': '地区管理', 'sort': 7, 'web_path': 'areaManage','icon': 'el-icon-menu', 'parent_id': '54f769b0-3dff-416c-8102-e55ec44827cc', 'component': None,'component_name': None, 'visible': 1, 'isautopm': 0},
            {'id': '25735adb-d051-4b7b-bbb7-1154526f3e4c', 'name': '个人中心', 'sort': 166,'web_path': 'personalCenter', 'icon': 'el-icon-s-custom', 'parent_id': None,'component': None, 'component_name': None, 'visible': 1,'isautopm':0},
    ...
    def init_menu_button(self):
        ...
        self.menu_button_data = [
            ...
            {'id': '963eba8fb65f460bb1ff8d053664c0ec', 'menu_id': 'fd29ed011f5e4fcda595977c132dbb7e',
             'name': '编辑', 'value': 'Update', 'api': '/api/address/area/{id}/', 'method': 2},
            {'id': '14e67b89963f47faa18ce017d4ac4061', 'menu_id': '154ccc5162ba4ba59b0ed298b16e4bb9',
             'name': '编辑', 'value': 'Update', 'api': '/api/mall/goodsspu/{id}/', 'method': 2},
            {'id': 'dc34311c28854633946422a05f6dfd6a', 'menu_id': 'cc36f1840dd043a58c8dcc1583ef53a7',
             'name': '编辑', 'value': 'Update', 'api': '/api/mall/goodstype/{id}/', 'method': 2},
            {'id': '9d9e88bc685747ec82f54f6f442fbd06', 'menu_id': '9f41e3f4199f43218f332dce9b085829',
             'name': '编辑', 'value': 'Update', 'api': '/api/mall/goodsorder/{id}/', 'method': 2},
            ...
            {'id': 'f6103fc9cb0f41b1903e6ced091816e7', 'menu_id': '144b872308704ddb9f549515361d4f08',
             'name': '查询', 'value': 'Search', 'api': '/api/platformsettings/userfeeckback/', 'method': 0},
            {'id': '134357cb6dc24ca0a5ff42cc571d85fa', 'menu_id': '154ccc5162ba4ba59b0ed298b16e4bb9',
             'name': '查询', 'value': 'Search', 'api': '/api/mall/goodsspu/', 'method': 0},
            {'id': '1f22f5d7c55e4c4f9a9da702b14b56a1', 'menu_id': 'cc36f1840dd043a58c8dcc1583ef53a7',
             'name': '查询', 'value': 'Search', 'api': '/api/mall/goodstype/', 'method': 0},
            {'id': 'ebee8cf7751e435987c5d787fddad557', 'menu_id': '4267b88be81141fb9c02bce4c0515e6d',
             'name': '查询', 'value': 'Search', 'api': '/api/mall/goodsforderinfo/', 'method': 0},
            {'id': '5777007b9dd34bb88410815bd9d45152', 'menu_id': '9f41e3f4199f43218f332dce9b085829',
             'name': '查询', 'value': 'Search', 'api': '/api/mall/goodsorder/', 'method': 0},
            ...
            {'id': '533c87fcaa7d450d8377a9bf916c7ffc', 'menu_id': 'fd29ed011f5e4fcda595977c132dbb7e',
             'name': '新增', 'value': 'Create', 'api': '/api/address/area/', 'method': 1},
            {'id': 'e5049ef7d64e434bb42d230b8b1d0e4a', 'menu_id': '154ccc5162ba4ba59b0ed298b16e4bb9',
             'name': '新增', 'value': 'Create', 'api': '/api/mall/goodsspu/', 'method': 1},
            {'id': '4da28a375a884915a35f0f05cc3f44d9', 'menu_id': 'cc36f1840dd043a58c8dcc1583ef53a7',
             'name': '新增', 'value': 'Create', 'api': '/api/mall/goodstype/', 'method': 1},
            ...
            {'id': '6d6b6689d1224900b09c8101b3344f42', 'menu_id': 'a607e820-36e5-45c0-aabf-85a8e4e2c7ac',
             'name': '单例', 'value': 'Retrieve', 'api': '/api/system/role_id_to_menu/{id}/', 'method': 0},
            {'id': '95666b657ce745bbba24ffdffa1eadfa', 'menu_id': 'fd29ed011f5e4fcda595977c132dbb7e',
             'name': '单例', 'value': 'Retrieve', 'api': '/api/address/area/{id}/', 'method': 0},
            {'id': '7f11e33d5067437ea91bdbb8f9f99829', 'menu_id': '144b872308704ddb9f549515361d4f08',
             'name': '单例', 'value': 'Retrieve', 'api': '/api/platformsettings/userfeeckback/{id}/', 'method': 0},
            {'id': '0843b95692344384904fe2a8a969226f', 'menu_id': '154ccc5162ba4ba59b0ed298b16e4bb9',
             'name': '单例', 'value': 'Retrieve', 'api': '/api/mall/goodsspu/{id}/', 'method': 0},
            {'id': 'a4e6a2ac7edb4c889f21d03e993f3395', 'menu_id': 'cc36f1840dd043a58c8dcc1583ef53a7',
             'name': '单例', 'value': 'Retrieve', 'api': '/api/mall/goodstype/{id}/', 'method': 0},
            {'id': 'f6788e8e6fb34558b6621ace6b376fdd', 'menu_id': '4267b88be81141fb9c02bce4c0515e6d',
             'name': '单例', 'value': 'Retrieve', 'api': '/api/mall/goodsforderinfo/{id}/', 'method': 0},
            {'id': '562cb75045cb4b2e8eb6fdfe0bbcc8a8', 'menu_id': '9f41e3f4199f43218f332dce9b085829',
             'name': '单例', 'value': 'Retrieve', 'api': '/api/mall/goodsorder/{id}/', 'method': 0},
            ...
            {'id': '27ae6d4d7bc34cf7a699974b8f330164', 'menu_id': '144b872308704ddb9f549515361d4f08',
             'name': '删除', 'value': 'Delete', 'api': '/api/platformsettings/userfeeckback/{id}/', 'method': 3},
            {'id': 'e4022163da0142fc88f0ea243fe33a86', 'menu_id': '154ccc5162ba4ba59b0ed298b16e4bb9',
             'name': '删除', 'value': 'Delete', 'api': '/api/mall/goodsspu/{id}/', 'method': 3},
            {'id': 'd569c03c938e41e6b80d3c42d7614690', 'menu_id': 'cc36f1840dd043a58c8dcc1583ef53a7',
             'name': '删除', 'value': 'Delete', 'api': '/api/mall/goodstype/{id}/', 'method': 3},
            {'id': 'dabe87cf5dd94e4ea79945e1cd45faf4', 'menu_id': '4267b88be81141fb9c02bce4c0515e6d',
             'name': '删除', 'value': 'Delete', 'api': '/api/mall/goodsforderinfo/{id}/', 'method': 3},
            {'id': '28be42da8f6046dabe9a9fe0e903c1c0', 'menu_id': '9f41e3f4199f43218f332dce9b085829',
             'name': '删除', 'value': 'Delete', 'api': '/api/mall/goodsorder/{id}/', 'method': 3},
            ...
            {'id': '5ef840afbea54dd88a89348088339be6', 'menu_id': '154ccc5162ba4ba59b0ed298b16e4bb9',
             'name': '禁用', 'value': 'Disable', 'api': '/api/mall/goodsspu/islaunched/{id}/', 'method': 2},
            {'id': '52790fa95e714357a79b9f79db46ad2f', 'menu_id': '4267b88be81141fb9c02bce4c0515e6d',
             'name': '统计', 'value': 'Statistics', 'api': '/api/mall/goodsforderinfo/orderstatistics/', 'method': 0},
            {'id': 'b96914b9b82b41889a2c22b7e9d278cb', 'menu_id': '9f41e3f4199f43218f332dce9b085829',
             'name': '统计', 'value': 'Statistics', 'api': '/api/mall/goodsorder/orderstatistics/', 'method': 0},
            {'id': 'f6a0c699c2ea40859eb6020c0ead13bb', 'menu_id': '9f41e3f4199f43218f332dce9b085829',
             'name': '发货', 'value': 'Deliver', 'api': '/api/mall/goodsorder/sendoutgoods/', 'method': 1},
        ]

...
""")
    ...
    def init_menu_button(self):
        ...
        self.menu_button_data = [
            ...
            {'id': '875bdfeb0c34441d8ee3bb93c21e17dd', 'menu_id': 'd73f73a399af48cea6a8490ac508d7a0',
             'name': '编辑', 'value': 'Update', 'api': '/api/users/users/{id}/', 'method': 2},
            ...
            {'id': 'b4cbe8ed35a04155b14c7809fad6b2ef', 'menu_id': '718daec1b94b456c96d773889648173e',
             'name': '编辑', 'value': 'Update', 'api': '/api/terminal/terminal/{id}/', 'method': 2},
            ...
            {'id': '43696212ecba4e66867833c9bc935c76', 'menu_id': 'd73f73a399af48cea6a8490ac508d7a0',
             'name': '查询', 'value': 'Search', 'api': '/api/users/users/', 'method': 0},
            ...
            {'id': 'c2490dfba1644cae8f8ff85e2d6f1d3d', 'menu_id': '9065cb5445ac42ef93eb9e75e6287792',
             'name': '查询', 'value': 'Search', 'api': '', 'method': 0},
            {'id': 'a69fb746c0aa4bd0b31b1480c9e4dcc0', 'menu_id': 'bcbeeee5c91a4e2ea2c2a31237e33616',
             'name': '查询', 'value': 'Search', 'api': '/api/monitor/getsysteminfo/', 'method': 0},
            {'id': 'e1ddf86666364a39be76c963c277b009', 'menu_id': '718daec1b94b456c96d773889648173e',
             'name': '查询', 'value': 'Search', 'api': '/api/terminal/terminal/', 'method': 0},
            ...
            {'id': '9fc8436a1996478fa1555de7939a54dc', 'menu_id': 'd73f73a399af48cea6a8490ac508d7a0',
             'name': '新增', 'value': 'Create', 'api': '/api/users/users/', 'method': 1},
            ...
            {'id': '8d65733d401c40f8b27cc6bcfed78bc3', 'menu_id': '718daec1b94b456c96d773889648173e',
             'name': '新增', 'value': 'Create', 'api': '/api/terminal/terminal/', 'method': 1},
            ...
            {'id': '14e7088fa39b47aebd67b9bbcabae96b', 'menu_id': 'd73f73a399af48cea6a8490ac508d7a0',
             'name': '单例', 'value': 'Retrieve', 'api': '/api/users/users/{id}/', 'method': 0},
            ...
            {'id': 'f19826f7df9842089cee94a795681b2e', 'menu_id': '9065cb5445ac42ef93eb9e75e6287792',
             'name': '单例', 'value': 'Retrieve', 'api': '', 'method': 0},
            {'id': 'ea18bb51400b482a8aad5dc18357bcab', 'menu_id': '718daec1b94b456c96d773889648173e',
             'name': '单例', 'value': 'Retrieve', 'api': '/api/terminal/terminal/{id}/', 'method': 0},
            ...
            {'id': 'bb7de9ee5fd146f59849088c522f49c7', 'menu_id': 'd73f73a399af48cea6a8490ac508d7a0',
             'name': '删除', 'value': 'Delete', 'api': '/api/users/users/{id}/', 'method': 3},
            ...
            {'id': '281ad1aad421441a965f7bc6b397eb30', 'menu_id': '718daec1b94b456c96d773889648173e',
             'name': '删除', 'value': 'Delete', 'api': '/api/terminal/terminal/{id}/', 'method': 3},
            ...
            {'id': '80c8eb6939a245e9890dede241b5d1d6', 'menu_id': 'd73f73a399af48cea6a8490ac508d7a0',
             'name': '禁用', 'value': 'Disable', 'api': '/api/users/users/disableuser/{id}/', 'method': 2},
            {'id': '6af0929440a345238c28ee9b1fe341ba', 'menu_id': '718daec1b94b456c96d773889648173e',
             'name': '终端', 'value': 'Terminal', 'api': '/ws/webssh/', 'method': 5},
        ]

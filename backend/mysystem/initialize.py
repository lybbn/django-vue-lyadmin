...
""")
    ...
    def init_menu(self):
        ...
        self.menu_data = [
            ...
            {'id': '5a05450c-cec2-4819-8d54-e0d6f6aac3a6', 'name': '用户管理', 'sort': 5,'web_path': '/user', 'icon': 'user','parent_id': '54f769b0-3dff-416c-8102-e55ec44827cc', 'component': 'system/user','component_name': 'user', 'visible': 0,'isautopm':0},
            ...
            {'id': '54f769b0-3dff-416c-8102-e55ec44827cc', 'name': '系统管理', 'sort': 10,'web_path': 'departmentManage', 'icon': 'el-icon-s-tools', 'parent_id': None,'component': None, 'component_name': None, 'visible': 1,'isautopm':0},

...
""")
    ...
    def init_menu(self):
        ...
        self.menu_data = [
            ...
            {'id': 'e0f53902-e901-490c-83f3-331e60b97fcf', 'name': '按钮配置', 'sort': 2,'web_path': 'buttonConfig', 'icon': 'el-icon-menu','parent_id': '54f769b0-3dff-416c-8102-e55ec44827cc', 'component': 'system/ menuButton', 'component_name': None, 'visible': 0,'isautopm':0},

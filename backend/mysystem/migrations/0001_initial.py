    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('isautopm', models.IntegerField(choices=[(0, '不自动创建'), (1, '自动创建')], default=1, help_text='自动创建按钮权限', verbose_name='自动创建按钮权限')),
                ('cache', models.IntegerField(choices=[(0, '禁用'), (1, '启用')], default=0, help_text='是否页面缓存', verbose_name='是否页面缓存')),
                ('visible', models.IntegerField(choices=[(0, '禁用'), (1, '启用')], default=1, help_text='侧边栏中是否显示', verbose_name='侧边栏中是否显示')),
                ('creator', models.ForeignKey(db_constraint=False, help_text='创建人', null=True, on_delete=django.db.models.deletion.SET_NULL, related_query_name='creator_query', to=settings.AUTH_USER_MODEL, verbose_name='创建人')),
        ...
        migrations.AddField(
            model_name='users',
            name='dept',
            field=models.ForeignKey(blank=True, db_constraint=False, help_text='关联部门', null=True, on_delete=django.db.models.deletion.CASCADE, to='mysystem.dept', verbose_name='所属部门'),
        ),
        migrations.AddField(
            model_name='users',
            name='groups',

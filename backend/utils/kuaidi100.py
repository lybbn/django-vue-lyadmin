...
# 快递100快递API接口
# ------------------------------
# 官网文档地址：https://api.kuaidi100.com/document/shishichaxunchanpinjieshao
# ------------------------------

import hashlib
import json
import requests
from config import KUAIDI100_KEY,KUAIDI100_CUSTOMER

class KuaiDi100:
    def __init__(self):
        self.key = KUAIDI100_KEY  # TODO 客户授权key
        self.customer = KUAIDI100_CUSTOMER  # TODO 查询公司编号
    ...
    def track(self, com, num, phone, ship_from, ship_to):
        ...
        param = {
            ...
            'show': self.show,  # 返回数据格式。0：json（默认），1：xml，2：html，3：text

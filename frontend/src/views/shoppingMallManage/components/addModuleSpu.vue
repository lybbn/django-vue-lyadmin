...
<!--&lt;!&ndash;                <img src="" style="width: 60px;height:60px">&ndash;&gt;-->
            ...
            <el-form-item label="分类：" prop="category_id" class="is-required">
                <el-select size="small" v-model="formData.category1" placeholder="请选择" clearable>
                    <el-option
            ...
            <el-form-item label="">
                <div class="messageTxt">
                    <quill-editor ref="myQuillEditor" v-model="formData.desc_detail" :options="editorOptions">
                    </quill-editor>
                </div>
            </el-form-item>
...
<script>
    import {mallGoodspuAdd,mallGoodspuEdit,retrieveUploadretrievecategoryimg,mallGoodscategory} from "@/api/api";
            ...
            submitData() {
                this.$refs['rulesForm'].validate(obj=>{
                    if(obj) {
                        ...
                        if(this.formData.id){
                            mallGoodspuEdit(param).then(res=>{
                                this.loadingSave=false
                                if(res.code ==2000) {

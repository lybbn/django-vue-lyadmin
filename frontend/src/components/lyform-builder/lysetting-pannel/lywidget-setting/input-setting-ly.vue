    ...
    <div>
        <el-form size="small" label-position="left" label-width="100px" class="lywidgetsetting" @submit.prevent>
            ...
            <el-form-item label="头部Icon">
                <el-input v-model="optionModel.prefixIcon"  style="width: 100%" @change="handleChange"></el-input>
            </el-form-item>
            <el-form-item label="尾部Icon">
                <el-input v-model="optionModel.suffixIcon"  style="width: 100%" @change="handleChange"></el-input>
            </el-form-item>
            <el-form-item label="前缀">
                <el-input v-model="optionModel.prependSlot"  style="width: 100%" @change="handleChange"></el-input>
            </el-form-item>
            <el-form-item label="后缀">
                <el-input v-model="optionModel.appendSlot"  style="width: 100%" @change="handleChange"></el-input>
            </el-form-item>

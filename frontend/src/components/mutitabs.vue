<template>
  <div class="myeltas1">
    ...
    <ul
        ...
        class="contextmenu">
        <li @click="reloadPage"><i class="el-icon-refresh"></i><span class="contextmenu-text">刷新</span></li>
        <li @click="closeAllTabs"><i class="el-icon-error"></i><span class="contextmenu-text">关闭所有</span></li>
        <li @click="closeOtherTabs('left')"><i class="el-icon-back"></i><span class="contextmenu-text">关闭左边</span></li>
        <li @click="closeOtherTabs('right')"><i class="el-icon-right"></i><span class="contextmenu-text">关闭右边</span></li>
        <li @click="closeOtherTabs('other')"><i class="el-icon-circle-close"></i><span class="contextmenu-text">关闭其他</span></li>
        <li @click="closeContextMenu()"><i class="el-icon-close"></i><span class="contextmenu-text">取消操作</span></li>
      </ul>
    <keep-alive>
      <router-view v-if="$route.meta.isActive&&isRourterAlive"></router-view>
    </keep-alive>
      <router-view v-if="!$route.meta.isActive&&isRourterAlive"></router-view>
  </div>
</template>
